       ...
       <h4 
         ...
         <div class="input-group" style="width: 350px;">
            ...
            <div class="input-group-prepend" style="display:inline-block;">
               <select class="" name="searchtype" id="searchtype" style="float: left;height: 38px;">
               ...
               <input type="text" class="form-control" placeholder="상품이름 검색" name="keyword" id="keyword" value="${keyword}"
                  aria-describedby="inputGroupPrepend" style="display:inline-block;width:220px">
                  <button  style="height:38px; float:right;" type="submit" class="input-group-text" id="inputGroupPrepend"><i
           ...
           <input type="hidden" value="${returnlist.returnnum}" id=returnnum${status.index} name=returnnum${status.index} />                
            <div class="w-full overflow-hidden rounded-lg shadow-xs">            
                ...
                <div>
                    ...
                    >
                      <h6 class="px-4 py-3" style="border-top: 1px solid black; border-bottom:1px solid #E6E6E6; ">
                      ...
                      주문번호: ${returnlist.buynum}<br>       
                         <span style="float:right;margin-top:-1rem" >  
                            ...
                            <c:choose>
                               ...
                               <c:when test="${name == 3}">    
                                <a  href="cancledetail?returnnum=${returnlist.returnnum}" style="color:#0073e9">상세보기</a>   
                               </c:when>
                               <c:when test="${name == 2}">    
                                <a  href="returndetail?returnnum=${returnlist.returnnum}" style="color:#0073e9">상세보기</a>   
                               </c:when>
                         ...
                         <div  class="flex items-center text-sm">
                          <!-- Avatar with inset shadow -->
                             <div style="float: left;">    
                               ...
                               <img  style="padding-top:15px;padding-left:10px; max-width: 150px;"  
                                 src="${returnlist.dv_order_itemDTO.cartDTO.imgDTO.url}${returnlist.dv_order_itemDTO.cartDTO.imgDTO.imgname}"
                                 alt=""
                                 loading="lazy"
                               /></a>
                          </div>
                             <div style="float:left;padding:15px 30px;width: calc(100% - 300px)">
                               ...
                               <p class="text-xs text-gray-600 dark:text-gray-400">
                                 ${returnlist.itembname}/${returnlist.itemsname} <br>
                             ...
                             <div style="float:right;align:center;">
                              <span class="items-center text-sm" style="float:right;width: 136px;
                         padding: 5px 3px 3px" >  
                              <a style="font-size:20px;color:#0073e9;margin-bottom: 7px">${returnlist.typename} ${returnlist.sta}</a>
                              <br>
                               <a> ${returnlist.dv_order_itemDTO.cartDTO.itemDTO.itempay} 원 / ${returnlist.pay}</a>
...
<!-- 페이징 처리 -->
<div class="pagination" padding-top: 15px;">
    <c:choose>
