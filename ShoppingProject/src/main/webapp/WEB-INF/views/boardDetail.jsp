...
<article id="bo_v" style="width:100%">
    ...
    <section id="bo_v_info">
        ...
        <strong class="if_date"><span class="sound_only">작성일</span><i class="fa fa-clock-o" aria-hidden="true"></i> ${regdate}</strong>
    </section>
    ...
    <div id="bo_v_top">
        ...
        <ul class="bo_v_com">
        				...
        				<c:if test="${sessionScope.user.authority eq 2}">
           				<li><a href="boardUpdateView?bno=${bno}" class="btn_b01 btn"> 수정</a></li>

           				<li><a href="boardDelete?bno=${bno}" class="btn_b01 btn" onclick="return boardDelete();"><i class="fa fa-trash"  ></i> 삭제</a></li>
							</c:if>
							
                       <li><a href="boardList" class="btn_b01 btn"><i class="fa fa-list" aria-hidden="true"></i> 목록</a></li>
                    </ul>
