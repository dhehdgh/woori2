		...
		<div class="d2 " style="padding-top: 50px;">
								...
								<td class="testtd">
									...
									<div style="display: block;">
										<div class="testbox8" style="height: 150px">
											 <div>    
				                             <a href="itemdetail?itemnum=${returnForm.dv_order_itemDTO.cartDTO.itemnum}">            	
											...
											<div class="testbox9">
												<div class="testbox10" style="padding-top: 20px;padding-left:10px">
													<span class="testbox11">${returnForm.dv_order_itemDTO.cartDTO.itemDTO.itemname}</span>
													<div>
														<p class="text-xs text-gray-600 dark:text-gray-400">
							                              옵션: ${returnForm.color}/${returnForm.size} <br>							                              
							                              ${returnForm.dv_order_itemDTO.cartDTO.itemcnt} 개
							                              <br>
							                              <span class="font-semibold">
							                              ${returnForm.dv_order_itemDTO.cartDTO.itemDTO.itempay} 원
							                              </span>
							                            </p>
													</div>
												</div>
			...
			<div class="testff" style="margin-top: 45px;">
				...
				<input type="hidden" value="${returnForm.dv_order_itemDTO.dv_itemno}" id="dv_itemno" name="dv_itemno" /> 
					...
					<input type="radio" name="type" value="3" checked>&nbsp;반품<br>					
						</div></div>
				...
				<div class="c1">
					...
					<div class="c2">
						<button type="submit" id="re" name="re" class="c4" >취소 신청</button>
					</div>
				</div>
				</form>
			</div>
