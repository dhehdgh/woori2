      ...
      <div class="d2 " style="padding-top: 50px;">
         ...
         <div class="testff" style="margin-top: 45px;">
                        ...
                        <th style="font-size: 0.875rem;" rowspan="2" class="b4">
                           <div class=" b5">
                              ...
                              <div style="color: #111111" class="b7">
                                 <strong><fmt:formatNumber value="${returnForm.dv_order_itemDTO.cartDTO.itemDTO.itempay*returnForm.dv_order_itemDTO.cartDTO.itemcnt}" pattern="#,###"/></strong>
                              </div>
                              <div class="after"></div>
                           </div>
                           <div class=" b5">
            ...
            <input type="hidden" value="${returnForm.dv_order_itemDTO.dv_itemno}" id="dv_itemno" name="dv_itemno" /> 
               ...
               <input type="radio" name="type" value="3" checked>&nbsp;취소<br>               
                  </div></div>
