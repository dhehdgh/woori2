...
function popupSubmit() {
     window.opener.name = "popaddrlist1"; // 부모창의 이름 설정
     document.popForm.target = "popaddrlist1"; // 타켓을 부모창으로 설정 
    ...
    <div class="container">
     ...
     <div class="card-body">  
            ...
            배송지 추가</h4><br><br> 
                  ...
                  <form action="${contextPath}/board/popaddrinsert1" method="POST" name="popForm">
