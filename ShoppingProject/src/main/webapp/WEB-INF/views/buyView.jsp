...
<meta name="keywords" content="NUSINSA" /></head><body id="userStyle">    <!-- [상단영역] -->
    ...
    <div class="header">
        ...
        <div class="headerMenu gRight">
            <span class="xans-element- xans-layout xans-layout-orderbasketcount btnBasket "><a href="${contextPath}/board/cartView?membernum=${user.membernum}">장바구니<span class="count  EC-Layout_Basket-count-display"><span class="EC-Layout-Basket-count">${count}</span></span></a>
</span>
