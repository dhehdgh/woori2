...
<div id="wrapper">
	...
	<div id="content"  class="col-md-9">
		...
		<div class="s_wrap">
			...
			<form action="${contextPath}/board/adminMemberRegister" method="post">
				<h2>사이트 이용정보 입력</h2>
				<div class="tbl_frm01">
					<table>
					<colgroup>
				...
				<div class="tbl_frm01">
				   ...
				   <tr>
					...
					<tr>
						...
						<td>
				            <input type="radio" name="agree" value="1" id="yes" checked>
				            <label for="yes">예</label>
				            <input type="radio" name="agree" value="2" id="no">
				            <label for="no">아니오</label>
				        </td>
						<th scope="row">권한</th>
						<td>
				            <input type="radio" name="authority" value="1" id="general" checked>
				            <label for="general">일반회원</label>
				            <input type="radio" name="authority" value="2" id="admin">
    ...
    <script>
       	...
       	$(function(){
        	$("#checkID").click(function(){
        		...
        		$.ajax({
        			url : "${contextPath}/board/adminCheckID",
        		  	type : "post",
        		  	data : {id : id},
