                ...
                <div class="col-lg-3">
                    <div class="left_sidebar_area">
                        <aside class="left_widgets p_filter_widgets">
                            ...
                            <form id="sortForm" action="pants" method="post">
                                <ul class="list">
                                	<li>
									    <a href="#" onclick="handleSortBySelection('default')">전체</a>
									</li>
                                    <li>
									    <a href="#" id="autoClickLink" onclick="handleSortBySelection('items01')">데님 팬츠</a>
									</li>
                                    <li>
                                        <a href="#" id="autoClickLink1" onclick="handleSortBySelection('items02')">트레이닝 팬츠</a>
                                    </li>
                                    <li>
                                        <a href="#" id="autoClickLink2" onclick="handleSortBySelection('items03')">코튼 팬츠</a>
                                    </li>
                                    <li>
                                        <a href="#" id="autoClickLink3" onclick="handleSortBySelection('items04')">슬랙스</a>
                                    </li>
                                </ul>
                        ...
                        <div class="col-lg-12">
                            <div class="product_top_bar d-flex justify-content-between align-items-center">
                                ...
                                <div class="single_product_menu d-flex">
                                    ...
                                    <form action="${contextPath}/board/pants" method="get" style="display: flex;">
						            ...
						            <ul class="pagination justify-content-center">
								        <c:choose>
								            <c:when test="${currentPage > 1}">
								                <li class="page-item"><a class="page-link" href="${contextPath}/board/pants?page=${currentPage - 1}&pageSize=${pageSize}&sortBy=${sortBy}&keyword=${keyword}" aria-label="Previous">
								        ...
								        <c:forEach var="pageNum" begin="1" end="${totalPages}">
								            <c:choose>
								                ...
								                <c:otherwise>
								                    <li class="page-item"><a class="page-link" href="${contextPath}/board/pants?page=${pageNum}&pageSize=${pageSize}&sortBy=${sortBy}&keyword=${keyword}">${pageNum}</a></li>
								                </c:otherwise>
								            </c:choose>
								        </c:forEach>
								        ...
								        <c:choose>
								            <c:when test="${currentPage < totalPages}">
								                <li class="page-item"><a class="page-link" href="${contextPath}/board/pants?page=${currentPage + 1}&pageSize=${pageSize}&sortBy=${sortBy}&keyword=${keyword}" aria-label="Next">
