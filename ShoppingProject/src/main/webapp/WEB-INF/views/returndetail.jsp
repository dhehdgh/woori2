                   ...
                   <tbody>
                       ...
                       <td>
                          ...
                          <h1 style="font-size:28px;text-align:center">${returndetail.dv_order_itemDTO.cartDTO.itemDTO.itemname}</h1>
                            ...
                            욥션: ${returndetail.color} / ${returndetail.size}</h6>                           
                   ...
                   <table class="w-full whitespace-no-wrap">                
                      <tr>                     
                        <th class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">    
                          <h1 class="px-4 py-3" style="text-align:center">회수자</h1>                                                                
                       </th>
                          <td class="border px-4 py-3">                          
                             <h1 style="text-align:center">${returndetail.dv_order_itemDTO.cartDTO.memberDTO.name}</h1>                                                                              
                          </td>
                  </tr>
                   <tr>                     
                        <th class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">    
                          <h1 class="px-4 py-3" style="text-align:center">연락처</h1>                                                                
                       </th>
                          <td class="border px-4 py-3">                          
                             <h1 style="text-align:center">${returndetail.dv_order_itemDTO.cartDTO.memberDTO.tel}</h1>                                                                              
                          </td>
                  </tr>
                  <tr>                     
                        <th class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">    
                          <h1 class="px-4 py-3" style="text-align:center">회수 주소</h1>                                                                
                       </th>
                          <td class="border px-4 py-3">                          
                             <h1 style="text-align:center">
                             ${returndetail.dv_orderDTO.addressDTO.delpostcode}<br>                             
                             ${returndetail.dv_orderDTO.addressDTO.delroadaddr} &nbsp;
                             ${returndetail.dv_orderDTO.addressDTO.deldetailaddr}&nbsp;
