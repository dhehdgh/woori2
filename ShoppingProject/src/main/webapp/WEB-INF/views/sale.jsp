                        ...
                        <div class="col-lg-12">
                            <div class="product_top_bar d-flex justify-content-between align-items-center">
                                ...
                                <div class="single_product_menu d-flex">
                                    ...
                                    <form action="${contextPath}/board/sale" method="get" style="display: flex;">
						            ...
						            <ul class="pagination justify-content-center">
								        <c:choose>
								            <c:when test="${currentPage > 1}">
								                <li class="page-item"><a class="page-link" href="${contextPath}/board/sale?page=${currentPage - 1}&pageSize=${pageSize}&keyword=${keyword}" aria-label="Previous">
								        ...
								        <c:forEach var="pageNum" begin="1" end="${totalPages}">
								            <c:choose>
								                ...
								                <c:otherwise>
								                    <li class="page-item"><a class="page-link" href="${contextPath}/board/sale?page=${pageNum}&pageSize=${pageSize}&keyword=${keyword}">${pageNum}</a></li>
								                </c:otherwise>
								            </c:choose>
								        </c:forEach>
								        ...
								        <c:choose>
								            <c:when test="${currentPage < totalPages}">
								                <li class="page-item"><a class="page-link" href="${contextPath}/board/sale?page=${currentPage + 1}&pageSize=${pageSize}&keyword=${keyword}" aria-label="Next">
