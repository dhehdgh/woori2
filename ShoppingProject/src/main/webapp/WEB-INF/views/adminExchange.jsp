			...
			<div class="s_wrap">
					...
					<tr>
						...
						<td>
							<select id="searchType" name="searchType">
								<option value="R.returnnum">교환번호</option>
					...
					<tr>
						...
						<td>
							<select name="dateType">
								<option value="returndate">교환신청일</option>
								<option value="recomdate">교환완료일</option>
				...
				<div class="tbl_head01">
					<table id="myTable" class="table table-bordered table-striped table-hover table-responsive">
						...
						<thead>
							<tr>
						        <th scope="col" onclick="sortTable(0)" class="active">교환번호</th>
						        ...
						        <th scope="col" onclick="sortTable(6)" class="active">교환신청일</th>
						        <th scope="col" onclick="sortTable(7)" class="active">교환완료일</th>
    ...
    <script>
	    ...
	    $(function(){
	    	$("#searchButton").click(function(){
		        ...
		        $.ajax({
		            url: "${contextPath}/board/adminExchangeSearch",
		            type: "get",
		            data: formData,
		            dataType: "json",
		            ...
		            success: function (response) {
		                ...
		                for (var i = 0; i < response.searchResult.length; i++) {
		                	var adminExchange = response.searchResult[i];
							
		                    var row = $("<tr>").appendTo(tableBody);
		                    $("<td>").text(adminExchange.returnnum).appendTo(row);
		                    ...
		                    row.on("click", function () {
		                        ...
		                        window.location.href = "${contextPath}/board/adminExchangeDetail?returnnum=" + returnnum;
		                    });
