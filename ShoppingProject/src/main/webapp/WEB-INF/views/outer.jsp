                ...
                <div class="col-lg-3">
                    <div class="left_sidebar_area">
                        <aside class="left_widgets p_filter_widgets">
                            ...
                            <form id="sortForm" action="outer" method="post">
                                <ul class="list">
                                	<li>
									    <a href="#" onclick="handleSortBySelection('default')">전체</a>
									</li>
                                    <li>
									    <a href="#" id="autoClickLink" onclick="handleSortBySelection('items01')">후드집업</a>
									</li>
                                    <li>
                                        <a href="#" id="autoClickLink1" onclick="handleSortBySelection('items02')">코트</a>
                                    </li>
                                    <li>
                                        <a href="#" id="autoClickLink2" onclick="handleSortBySelection('items03')">가디건</a>
                                    </li>
                                    <li>
                                        <a href="#" id="autoClickLink3" onclick="handleSortBySelection('items04')">패딩</a>
                                    </li>
                                    <li>
                                        <a href="#" id="autoClickLink4" onclick="handleSortBySelection('items05')">재킷</a>
                                    </li>
                                </ul>
                        ...
                        <div class="col-lg-12">
                            <div class="product_top_bar d-flex justify-content-between align-items-center">
                                ...
                                <div class="single_product_menu d-flex">
                                    ...
                                    <form action="${contextPath}/board/outer" method="get" style="display: flex;">
...
window.onload = function() {
  ...
  if (path == 1) {
	    ...
	    var link = document.getElementById('autoClickLink4');
	    link.click(); // 해당 링크를 자동으로 클릭
	}  else {
		alert(path)
	}
