		...
		<form method="POST">
			<div class="helpcontent">
				<div class="helpmaintitle">
					<span class="helpheader">1:1문의하기</span>
				</div>
					...
					<div class="my-review__modify__review">
						...
						<div class="my-review__field__content">
							<input class="my-review__field__content__input summary"
								type="text" placeholder="문의제목" value="" maxlength="30"
								id="itile" name="title">
						</div>
					</div>
					...
					<div class="my-review__modify__review__content">
						...
						<div class="my-review__modify__review__content__text-wrap">
							<textarea class="my-review__modify__review__content__text-area"
								placeholder="문의내용" rows="5" id="content" name="content"></textarea>
						</div>
					</div>
				</div>
				<div class="review-intake-register">
					<button class="cancel-button _review-cancel" type="button"
						onclick="location.href='${contextPath}/board/myhelplist'">취소하기</button>
					<button class="submit-button _review-submit" type="submit" id="ok"
						name="ok">문의하기</button>
				</div>
			</div>
		</form>
