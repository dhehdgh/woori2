    ...
    <div class="container">
     ...
     <div class="card-body">  
            ...
            배송지 수정</h4><br><br> 
                  ...
                  <form action="${contextPath}/board/popaddrupdate1" method="POST">
                 ...
                 <div style="text-align:center;disply:block;padding-top:45px">
                  ...
                  <button  type = "button" style="color:#ff3368;border: solid 1px;float:center" id="list" name="list" class="email_icon newsletter-submit button-contactForm" onclick='location.href="popaddrlist1";' >목록</button>
              </div>     
                </form>
             </div>
