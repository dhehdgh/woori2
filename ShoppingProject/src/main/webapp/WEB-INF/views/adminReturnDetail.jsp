	        ...
	        <div class="row justify-content-center">
	          <div class="col-lg-8">
	            	<form class="row contact_form" action="${contextPath}/board/adminReturnDetail" method="post">
			            ...
			            <div class="col-md-10 form-group p_star">
			              <input type="text" class="form-control" id="cartno" name="cartno" value="${re.orderDTO.cartno}" readonly>
			            </div>
			            <div class="col-md-2 form-group p_star">
			              <label for="addrnum" class="col-form-label">배송지</label>
			            </div>
			            <div class="col-md-10 form-group p_star">
			              <input type="text" class="form-control" id="addrnum" name="addrnum" value="${re.orderDTO.addrnum}" readonly>
			            </div>
			            <div class="col-md-2 form-group p_star">
			              <label for="paymethod" class="col-form-label">결제방식</label>
			            </div>
			            <div class="col-md-10 form-group p_star">
			              <input type="text" class="form-control" id="paymethod" name="paymethod" value="${re.orderDTO.paymethod}" readonly>
			            </div>
			            <div class="col-md-2 form-group p_star">
			              <label for="payment" class="col-form-label">결제금액</label>
			            </div>
			            <div class="col-md-10 form-group p_star">
			              <input type="text" class="form-control" id="payment" name="payment" value="${re.orderDTO.payment}" readonly>
			            </div>
			            <div class="col-md-2 form-group p_star">
			              <label for="buydate" class="col-form-label">주문날짜</label>
			            </div>
			            <div class="col-md-10 form-group p_star">
			              <input type="text" class="form-control" id="buydate" name="buydate" value="${re.orderDTO.buydate}" readonly>
			            </div>
	              		<div class="col-md-2 form-group p_star">
