...
<html lang="en">
    ...
    <div id="content" class="col-md-9">
		...
		<div class="s_wrap">
			<h1>반품내역 상세</h1>
			<form action="${contextPath}/board/adminReturnDetail" method="post">
				...
				<div class="btn_confirm">
					<button type="submit" class="genric-btn info large thick">반품처리</button>
