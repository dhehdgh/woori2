...
public class itemreturnDTO {
	...
	public String toString() {
		return "itemreturnDTO [returnnum=" + returnnum + ", buynum=" + buynum + ", returncontent=" + returncontent
				+ ", returndate=" + returndate + ", state=" + state + ", type=" + type + ", itemsname=" + itemsname
				+ ", itembname=" + itembname + ", typename=" + typename + ", pay=" + pay + ", sta=" + sta + ", color="
				+ color + ", size=" + size + ", recomdate=" + recomdate + ", dv_itemno=" + dv_itemno + ", keyword="
				+ keyword + ", searchtype=" + searchtype + ", dv_order_itemDTO=" + dv_order_itemDTO + ", dv_orderDTO="
				+ dv_orderDTO + ", addressDTO=" + addressDTO + ", itemDTO=" + itemDTO + ", memberDTO=" + memberDTO
				+ "]";
	}
