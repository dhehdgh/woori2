...
<%@ include file="include/mypage_left_column.jsp"%>
	<div class="col-lg-10" style="padding-top: 50px;">
		...
		<div style="padding-top: 40px; padding-left: 20px;">
			...
			<c:forEach var="dv_orderlist" items="${dv_orderlist}">
			...
			<input type="hidden" value="${dv_orderlist.dv_order_itemDTO.buynum}" />
				<div class="testbox">
					<div class="testbox2">
						<div class="testbox3"> ${dv_orderlist.buydate} 주문
						</div>
						<div class="testbox4">
				                            ...
				                            /></a>
												...
												<div class="testbox9">
													<div class="testbox10" style="padding-top: 20px;margin-left: 66px">
														...
														<span class="testbox11">옵션: ${dv_orderlist.color}/${dv_orderlist.size}</span>
														<div>
															<div class="testbox13" style="padding-top: 30px;">
																<span class="testbox14">${dv_orderlist.dv_order_itemDTO.cartDTO.itemcnt}개 <br>${dv_orderlist.dv_order_itemDTO.cartDTO.itemDTO.itempay}원
																...
																<button class="testbtn testbtn2">장바구니 담기</button>
															</div>
														</div>
													</div>
												</div>
									...
									<td class="testtd2" style="width: 205px;">
										...
										<!-- 리뷰 썻으면(2) // 작성리뷰보기 -->
											<c:choose>
												...
												<c:when test="${dv_orderlist.review eq 2}">
													<button class="reviewbtn1 reviewbtn2"
														onclick="location.href='${contextPath}/board/reviewdelete?reviewno=${reviewlist.reviewDTO.reviewno}'">작성리뷰보기</button>
												</c:when>
												<c:otherwise>
												</c:otherwise>
											</c:choose>
