...
<%@ include file="include/mypage_left_column.jsp"%>
	...
	<div class="d2 " style="padding-top: 50px;">
		<div class="l_w_title" style="float: left;">
			<h2>주문상세</h2>
			<br>
			<div style="float: right;" class="testbox3">${orderdetail.buydate}/ 주문번호 ${orderdetail.buynum}
				2</div>
			<br>
		</div>
		<div
						...
						<tr class="testtr">
								...
								<div class="testdiv1">
									<div class="testdiv2">
										...
										<span style="size: 4" class="test_dv2"> <span
											...
											class="fontsize dv_date">${orderdetail.deliverycom} <a
											style="color: black;">${orderdetail.sta}</a></span>
									</div>
								</div>
										...
										<div class="testbox9">
											<div class="testbox10" style="padding-top: 20px;">
												...
												<p class="text-xs text-gray-600 dark:text-gray-400">
							                              옵션: ${orderdetail.color}/${orderdetail.size} <br>	</p>
												<div>
													<div class="testbox13" style="padding-top: 50px;">
														<span class="testbox14">${orderdetail.dv_order_itemDTO.cartDTO.itemDTO.itempay} 원</span> <span
															class="testbox14"> <span class="testbox15">
														</span></span> <span class="testbox11"> ${orderdetail.dv_order_itemDTO.cartDTO.itemcnt} 개 </span> <a
															class="ttest testbox12" style="padding-left: 150px;"></a>
														<button class="testbtn testbtn2">장바구니 담기</button><br>
													</div>
												</div>
											</div>
										</div>
							...
							<td class="testtd2" style="width: 205px;">
								...
								<input type="hidden" value="${orderdetail.dv_order_itemDTO.buynum}" />
									<a type ="button"" class="reviewbtn1 reviewbtn2" 
										href="" >리뷰 작성하기</a>
									<a type="button" class="reviewbtn1 reviewbtn2"
		...
		<div class="testff" style="margin-top: 45px;">
					...
					<tbody class="b1">
						...
						<tr class="b2">
							<th style="font-size: 0.875rem" class=" b9"><div
									style="font-size: 1rem; color: #111" class=" b11">${orderdetail.pay}</div></th>
						</tr>
					</tbody>
					<tbody class=" b12">
						<tr class=" b2">
							...
							<td style="font-size: 0.875rem" class=" b18"><div
									class=" b13">
									<div class=" b10">${orderdetail.pay}</div>
									<div class=" b14">
										<strong>30,000 원</strong>
									</div>
									<div class="after"></div>
			...
			<div class="c1">
				<div class="b10">
					<a type="button" class="c3" href="${contextPath}/board/myorderlist">
						주문목록 돌아가기
					</a>
				</div>
				<div class="c2">
