...
public class memberDTO {
	...
	public String toString() {
		return "memberDTO [usePoint=" + usePoint + ", membernum=" + membernum + ", id=" + id + ", pw=" + pw + ", name="
				...
				+ pointac + ", joindate=" + joindate + ", state=" + state + ", authority=" + authority + ", gender="
				+ gender + ", agree=" + agree + ", gen=" + gen + ", roadaddr=" + roadaddr + ", jibunaddr=" + jibunaddr
				+ ", detailaddr=" + detailaddr + ", extraaddr=" + extraaddr + ", postcode=" + postcode + ", addressDTO="
				+ addressDTO + ", deleteagree=" + deleteagree + "]";
	}
