...
public class itemDTO {
	...
	public String toString() {
		return "itemDTO [itemnum=" + itemnum + ", itemname=" + itemname + ", itempay=" + itempay + ", itemdate="
				...
				+ rstar + ", sale=" + sale + ", iv_itemDTO=" + iv_itemDTO + ", codetableDTO=" + codetableDTO
				+ ", imgDTO=" + imgDTO + ", imgnum=" + imgnum + ", numbers=" + numbers + ", count=" + count
				+ ", imgname=" + imgname + ", url=" + url + ", allitemsize=" + allitemsize + ", allitemcolor="
				+ allitemcolor + ", mylistDTO=" + mylistDTO + ", heart=" + heart + ", rcount=" + rcount + ", rstarsum="
				+ rstarsum + ", buycntsum=" + buycntsum + ", ravg=" + ravg + ", reviewDTO=" + reviewDTO
				+ ", total_buycnt=" + total_buycnt + "]";
	}
