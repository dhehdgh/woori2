...
<c:forEach items="${item}" var="item">
 <c:set var="count" value="${item.count}" scope="request" />
 </c:forEach>
    <!--================Home Banner Area =================-->
    <!-- breadcrumb start-->
                        ...
                        <div class="col-lg-4 col-sm-6">
                            ...
                            <a href="${contextPath}/board/itemDetail?itemnum=${item.itemnum}">
                                <img src="${item.url}${item.imgname}" alt="">
                                 ...
                                 <a href="#" class="add_cart"><img src="https://www.byslim.com/morenvyimg/d_wish.gif" alt="Like Icon">${item.heart}</a>
                                 <img src="https://image.msscdn.net/skin/musinsa/images/icon_like_small_on.png">
                                 </div>
                                <div class="single_product_text">
                                    <h4>${item.itemname}</h4>
                                    <h3><script>document.write((${item.itempay}).toLocaleString())</script>원</h3>
