...
<div class="xans-element- xans-order xans-order-dcinfo ec-base-box typeMember  "><div class="information">
            ...
            <div class="description">
                ...
                <ul class="mileage">
<li><a href="/myshop/mileage/historyList.html">포인트 : <strong>${user.point}P</strong></a></li>
                    <li><a href="/myshop/coupon/coupon.html">등급 : <strong>${rating}</strong></a></li>
                </ul>
</div>
        </div>
</div>
...
<tfoot class="right"><tr>
            ...
            <tbody class="xans-element- xans-order xans-order-list center"><tr class="xans-record-">
                ...
                <td class="thumb gClearLine"><a href="#"><img src="${cart.imgDTO.url}${cart.imgDTO.imgname}"  alt="${cart.itemDTO.itemname}"/></a></td>
...
<script>
    ...
    if (colorEventActive) {
      $.post("colorSelect", { codestring: selectedColor, itemnum: itemValue })
        .done(function (data) {
          ...
          updateSelectOptions(sizeSelect, sizeOptionsData);
    ...
    if (sizeEventActive) {
      $.post("sizeSelect", { codestring: selectedSize, itemnum: itemValue })
        .done(function (data) {
          ...
          updateSelectOptions(colorSelect, colorOptionsData);
  ...
  function updateSelectOptions(selectElementData, data) {
