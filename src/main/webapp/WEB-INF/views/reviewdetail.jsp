	...
	<div class="my-area-body">
		<div class="my-area-contents">
			<div class="my-review__title">
				<span class="my-review__main__header">리뷰상세</span>
							...
							<div class="review-intake-form__rating">
								<div class="review-table">
									...
									<div class="review-table__cell description">
										<div class="review-intake-form__product-title" style="margin-top: 20px;">${reviewdetail[0].itemDTO.itemname}</div>

											<div class="my-review__modify__star__content">
												<a style="margin-top: 20px; margin-bottom: 20px;">옵션 : ${reviewdetail[0].color} / ${reviewdetail[0].size}</a>
												<div style="padding-top: 15px;">별점 &nbsp;&nbsp;&nbsp; 
									...
									<div class="my-review__modify__review__content">
										...
										<div class="my-review__modify__review__content__text-wrap">
											<textarea
												...
												rows="5" disabled>${reviewdetail[0].reviewDTO.rcontent}</textarea>
