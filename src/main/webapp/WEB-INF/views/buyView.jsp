...
<c:set var="user" value="${sessionScope.user}" />
    <c:forEach items="${buyView}" var="cart">
         ...
         <c:set var="point" value="${cart.memberDTO.point}" scope="request" />
          ...
          <c:set var="iv_itemnum" value="${cart.iv_itemnum}" scope="request" />
...
<meta name="keywords" content="NUSINSA" /></head><body id="userStyle">    <!-- [상단영역] -->
    ...
    <div class="header">
        ...
        <div class="headerMenu gRight">
            <span class="xans-element- xans-layout xans-layout-orderbasketcount btnBasket "><a href="${contextPath}/board/cartView">장바구니<span class="count  EC-Layout_Basket-count-display"><span class="EC-Layout-Basket-count">${cartcount}</span></span></a>
</span>
                        <a href="/myshop/index.html" class="xans-element- xans-layout xans-layout-statelogon btnMy ">(주문목록으로 이동)마이쇼핑
</a>
        </div>
    </div>
    <div class="titleArea">
...
<form method = "post" action = "orderInsert?cartno=${cartno}">
...
<div id="ec-jigsaw-area-benefit" class="ec-base-fold eToggle">
    ...
    <div class="contents">
        ...
        <div id="ec-orderform-benefit-tail"></div>
            ...
            <button type="submit" class="btnSubmit" id="orderInsert" onclick ="return orederInsert()"  style="width: 900px; height: 65px; font-size: 20px;">
