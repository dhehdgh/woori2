        ...
        <div class="col-lg-5 col-xl-5">
          <div class="s_product_text">
            ...
            <c:if test="${authority == 2}">
            	<a href="${contextPath}/board/adminitemUpdate" class="genric-btn primary-border small">수정</a>
            	<a href="${contextPath}/board/adminitemUpdate" class="genric-btn primary-border small">삭제</a>
			</c:if>
          </div>
        </div>
      </div>
    	    ...
    	    success: function(response) {
    	      ...
    	      $.ajax({
    	        ...
    	        success: function(response) {
    	          ...
    	          alert("결제화면으로 이동합니다.");
    	          // íì´ì§ ì´ë
    	          window.location.href = "${pageContext.request.contextPath}/board/buyView?cartno=&membernum=${membernum}";
    	        },
    	        error: function() {
